...
- `docs/documentacion/PROTOTIPO.md`: contexto de decisiones de diseño (léelo si necesitas entender el "porqué" de alguna regla del skill)
...
5. Lee `docs/documentacion/PROTOTIPO.md` (referencia, no obligatorio re-leer en cada iteración).
