...
Cuando te invocan tras detección de cambio estructural durante la fase de prototipo (ver `docs/documentacion/PROTOTIPO.md` §7 y skill `sdd-prototype` §8), tu flujo cambia: NO arrancas de cero, **actualizas el requirements.md existente** añadiendo el o los Requirements nuevos que el feedback del cliente reveló.
