...
Las decisiones de diseño detrás de estas reglas viven en `docs/documentacion/PROTOTIPO.md`. Si una regla aquí choca con ese doc, ese doc manda y este skill se actualiza.
...
Prohibido: React, Vue, Svelte, Next, cualquier framework con build. Si se cuela, viola la disciplina del framework (ver D3 y D13 en PROTOTIPO.md).
