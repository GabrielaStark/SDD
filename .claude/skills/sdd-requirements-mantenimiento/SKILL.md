...
Este skill es la fuente de verdad para producir `docs/features/<feature>/requirements.md` en el pipeline de **mantenimiento** del framework SDD. El subagente `analista-feature-mantenimiento` consulta este archivo. Cualquier `requirements.md` producido en este pipeline debe cumplir TODAS las reglas de aquí.
