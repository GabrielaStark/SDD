...
Este skill es la fuente de verdad para producir `docs/features/<feature>/tasks.md` en el pipeline de **mantenimiento** del framework SDD. El subagente `descompositor-riesgo-mantenimiento` consulta este archivo. Cualquier `tasks.md` producido en este pipeline debe cumplir TODAS las reglas de aquí.
