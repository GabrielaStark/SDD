...
Los headers de sección son **por capa arquitectónica**, no por feature. Esto refuerza el orden de dependencias.
...
- [ ] El archivo está organizado por capas arquitectónicas (Setup, Data Model, Data Access, Business Logic, API, UI, E2E, Docs).
...
- [ ] El orden respeta dependencias técnicas (datos → lógica → API → UI).
